...
Live Project URL: [DALVacationHome](https://dalvacationservice-w6miucx2da-uc.a.run.app/) (Might not work due to maintenance issues - Demo video available below)
...
[![Watch the demo](https://img.youtube.com/vi/qyIj9Wfpdpc/0.jpg)](https://www.youtube.com/watch?v=qyIj9Wfpdpc)

**Click to watch the demo** _(Based on project screenshots)_

For detailed technical documentation of each workflow, see the [docs/](docs/) folder.
...
All screenshots have been moved to the [assets/](assets/) folder for reference.
